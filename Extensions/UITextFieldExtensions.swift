...
//    
//    func addObserverForName(name: String?, object: AnyObject?, queue: OperationQueue?, usingBlock: NotificationHandler) {
//        // Register the specified object and notification with NSNotificationCenter
//        self.objectProtocol = NotificationCenter.defaultCenter.addObserverForName(name.map { NSNotification.Name(rawValue: $0) }, object: object, queue: queue, usingBlock: usingBlock)
//    }
//    
////    init() {
////        super.init()
...
//                notificationProxy.addObserverForName(name: NSNotification.Name.UITextFieldTextDidChange.rawValue, object: self, queue: nil, usingBlock: newValue)
